...
import AcademicAdvisor from './AcademicAdvisor.tsx';
import IPKProgressChart from './IPKProgressChart.tsx';
import { TARGET_SKS } from '../constants';
...
const Dashboard: React.FC<DashboardProps> = ({ semesters, ipk, totalCredits, ipkProgression }) => {
    ...
    return (
        <div className="space-y-8">
            ...
            <DashboardStats 
                ...
                targetCredits={TARGET_SKS}
            />

            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 bg-white p-6 rounded-lg shadow-md flex flex-col gap-8">
                    <div>
